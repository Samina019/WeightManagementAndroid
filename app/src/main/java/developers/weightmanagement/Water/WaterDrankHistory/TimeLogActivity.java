package developers.weightmanagement.Water.WaterDrankHistory;
...
import developers.weightmanagement.Water.MainWindow.TimePickerFragment;
import developers.weightmanagement.Water.Model.TimeLog;
...
public class TimeLogActivity extends AppCompatActivity implements View.OnClickListener, NumberPicker.OnValueChangeListener , TimePickerFragment.OnTimePickedListener {
    ...
    private void updateViews(){
        ...
        WaterFragment.circleProgress.setProgress(preValue);
        WaterFragment.choosenAmountTv.setText(String.valueOf(db.geConsumedWaterForToadyDateLog()
